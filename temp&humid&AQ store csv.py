...
output_filename = 'data_group7&8_temp&humid&AQ_place1.csv'
header = ("Timestamp","Temperature","Humid","AQ_value")
...
while True:
    try:
        ...
        data = [str(time.time()), str(temp), str(humidity),str(aq_value)] 
        strData = ';'.join(data) 
